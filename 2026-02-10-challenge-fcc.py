...
Today I'll be solving the daily challenge available on 10th, February, 2026.

----------------------------
2026 Winter Games Day 5: Cross-Country Skiing

Given an array of finish times for a cross-country ski race, 
convert them into times behind the winner.
...
3. get_relative_results(["1:10:06", "1:10:23", "1:10:48", "1:12:11"]) 
should return ["0", "+0:17", "+0:42", "+2:05"].
